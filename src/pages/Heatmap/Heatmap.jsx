...
function PopupClusterMenu(){
    ...
    return(
        <Paper elevation={24} className={s.cluster_popup} style={{position:'fixed', width:'15%', height: '61%', top: '25%', left: '0.5%', zIndex: '1000', borderRadius: '20px'}}>
...
function PopupMarkerMenu(point) {
    return(
        <Paper elevation={24} className={s.marker_popup} style={{position:'fixed', width:'20%', height: '87%', top: '10%', left: '0.5%', zIndex: '1000'}}>
